...
const DietShopOrdersTable = () => {
  const [page, setPage] = useState(1);
  const [loading, setLoading] = useState(false);
  const { data: orders, isLoading: ordersLoading } = useDietShopOrdersQuery({
    page,
  });
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#6B7280]">
                    New diet shop orders will appear here automatically.
                  </p>
                </div>
              </div>
            </div>
...
export default DietShopOrdersTable;
